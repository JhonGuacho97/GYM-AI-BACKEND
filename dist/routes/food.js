...
exports.foodRouter.post("/estimate", async (req, res) => {
    try {
...
exports.foodRouter.get("/today", async (req, res) => {
    try {
        ...
        const logs = await prisma_1.prisma.food_logs.findMany({
            where: {
                user_id: userId,
...
exports.foodRouter.delete("/:id", async (req, res) => {
    try {
        const id = req.params.id;
        await prisma_1.prisma.food_logs.delete({ where: { id } });
